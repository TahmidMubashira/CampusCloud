...
export default function Layout({ active, children, userName, userEmail }: LayoutProps) {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', minHeight: '100vh', background: '#f0f4f8', fontFamily: "'Nunito', sans-serif" }}>
      <style>{`
      ...
      <div className="cc-layout-inner">
        ...
        {/* Main Content */}
        <main className="cc-main" style={{ flex: 1, padding: '36px 40px', overflowY: 'auto', overflowX: 'hidden', minWidth: 0, width: '100%' }}>
          {children}
        </main>
